...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen flex justify-center items-center p-4 sm:p-8">
      <div className="w-full max-w-xl bg-white/80 backdrop-blur-md organic-border shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative flex flex-col min-h-[650px] overflow-hidden">
